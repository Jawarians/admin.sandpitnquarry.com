                        ...
                        @if ($customerAccounts->hasPages())
                            <nav aria-label="Customer Accounts pagination">
                                <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link bg-neutral-200 text-secondary-light fw-semibold radius-8 border-0 d-flex align-items-center justify-content-center h-32-px w-32-px text-md" href="{{ $customerAccounts->previousPageUrl() }}">
                                                <iconify-icon icon="ep:d-arrow-left"></iconify-icon>
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    @foreach ($customerAccounts->getUrlRange(1, $customerAccounts->lastPage()) as $page => $url)
                                        <li class="page-item {{ $page == $customerAccounts->currentPage() ? 'active' : '' }}">
                                            <a class="page-link {{ $page == $customerAccounts->currentPage() ? 'bg-primary-600 text-white' : 'bg-neutral-200 text-secondary-light' }} fw-semibold radius-8 border-0 d-flex align-items-center justify-content-center h-32-px w-32-px text-md" href="{{ $url }}">
                                                {{ $page }}
                                            </a>
                                        </li>
                                    @endforeach
                                    ...
                                    @if ($customerAccounts->hasMorePages())
                                        <li class="page-item">
                                            <a class="page-link bg-neutral-200 text-secondary-light fw-semibold radius-8 border-0 d-flex align-items-center justify-content-center h-32-px w-32-px text-md" href="{{ $customerAccounts->nextPageUrl() }}">
