                        ...
                        <div class="row row-cols-xxxl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-4">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-3">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="{{ asset('assets/images/currency/crypto-img1.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-1">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="{{ asset('assets/images/currency/crypto-img2.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-5">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="{{ asset('assets/images/currency/crypto-img3.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-6">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="{{ asset('assets/images/currency/crypto-img4.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                            ...
                            <div class="col">
                                <div class="card shadow-none border bg-gradient-end-3">
                                    <div class="card-body p-20">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            <img src="{{ asset('assets/images/currency/crypto-img5.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
