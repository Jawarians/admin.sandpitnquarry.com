                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[1][]" value="admin" id="cs_admin">
                                    <label class="form-check-label" for="cs_admin">Admin</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[1][]" value="manager" id="cs_manager">
                                    <label class="form-check-label" for="cs_manager">Manager</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[1][]" value="staff" id="cs_staff">
                ...
                <div class="col-md-12 mb-4">
                    <div class="card p-3">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[2][]" value="admin" id="pp_admin">
                                    <label class="form-check-label" for="pp_admin">Admin</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[2][]" value="manager" id="pp_manager">
                                    <label class="form-check-label" for="pp_manager">Manager</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[2][]" value="staff" id="pp_staff">
                ...
                <div class="col-md-12 mb-4">
                    <div class="card p-3">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[3][]" value="admin" id="op_admin">
                                    <label class="form-check-label" for="op_admin">Admin</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[3][]" value="manager" id="op_manager">
                                    <label class="form-check-label" for="op_manager">Manager</label>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="roles[3][]" value="staff" id="op_staff">
