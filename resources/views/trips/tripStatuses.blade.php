...
@php
    $title = 'Trip Statuses';
    $subTitle = 'Trip Status Management';
@endphp
...
<div class="card h-100 p-0 radius-12">
    <div class="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3 justify-content-between">
        <div class="d-flex align-items-center gap-3">
            ...
            <h5 class="card-title mb-0">Trip Statuses</h5>
        </div>
        ...
        <div class="row gy-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-16">
                        <div class="d-flex align-items-center gap-12">
                            <div class="w-40-px h-40-px bg-warning-50 rounded-circle d-flex justify-content-center align-items-center">
                                <iconify-icon icon="mdi:truck-check" class="text-warning-600 text-xl"></iconify-icon>
                            </div>
                    ...
                    <div class="mt-auto">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <iconify-icon icon="mdi:truck" class="text-secondary-light"></iconify-icon>
                                <span class="text-sm text-secondary-light">
                                    {{ $status->trips->count() ?? 0 }} trips
                                </span>
                            </div>
                        ...
                        <div class="mt-12">
                            <div class="d-flex align-items-center gap-2">
                                <iconify-icon icon="mdi:truck-fast" class="text-warning-600"></iconify-icon>
                                <span class="text-xs text-warning-600">In Transit</span>
                            </div>
                        </div>
                        @else
                        <div class="mt-12">
            ...
            <div class="col-12">
                <div class="d-flex flex-column align-items-center justify-content-center py-5">
                    ...
                    <h5 class="text-neutral-500 mb-2">No Trip Statuses Found</h5>
                    <p class="text-neutral-400 mb-0">There are no trip statuses configured in the system yet.</p>
                </div>
            </div>
            @endforelse
        </div>
    ...
    @if($statuses->count() > 0)
        <div class="mt-24 pt-20 border-top">
            <div class="row gy-3">
                ...
                <div class="col-md-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="text-sm text-secondary-light">
                            Total Trips: {{ $statuses->sum(function($status) { return $status->trips->count() ?? 0; }) }}
                        </span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="text-sm text-secondary-light">
                            Completed: {{ $statuses->where('is_completed', true)->sum(function($status) { return $status->trips->count() ?? 0; }) }}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-20">
                <h6 class="text-lg mb-16">Trip Status Flow</h6>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            @elseif($status->is_in_progress ?? false)
                                <div class="w-32-px h-32-px bg-warning-600 rounded-circle d-flex justify-content-center align-items-center">
                                    <iconify-icon icon="mdi:truck-fast" class="text-white text-sm"></iconify-icon>
                                </div>
                            @else
            ...
            <!-- Trip Status Legends -->
            <div class="mt-20">
                <h6 class="text-lg mb-16">Status Legends</h6>
                <div class="row gy-3">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center gap-2">
                            <div class="w-16-px h-16-px bg-info-600 rounded-circle"></div>
                            <span class="text-sm text-secondary-light">Scheduled/Planning</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex align-items-center gap-2">
                            <div class="w-16-px h-16-px bg-warning-600 rounded-circle"></div>
                            <span class="text-sm text-secondary-light">In Transit/Active</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex align-items-center gap-2">
                            <div class="w-16-px h-16-px bg-success-600 rounded-circle"></div>
                            <span class="text-sm text-secondary-light">Completed/Delivered</span>
                        </div>
                    </div>
                </div>
            </div>
